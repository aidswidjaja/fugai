"""
Shamelessly copied and pasted from https://github.com/learnpyqt/15-minute-apps/blob/master/browser_tabbed/, which is (also) licensed under the MIT License.
...
class webAboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        super(webAboutDialog, self).__init__(*args, **kwargs)
        ...
        layout.addWidget(QLabel("Version 1.0 - June 2020"))
        layout.addWidget(QLabel("Licensed under the MIT License"))
        layout.addWidget(QLabel("Based off Mozarella Ashbadger by mfitzp and other contributors,"))
        layout.addWidget(QLabel("available at https://github.com/learnpyqt/15-minute-apps"))
...
class webMainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        super(webMainWindow, self).__init__(*args, **kwargs)
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About fugaiWeb", self)
        about_action.setStatusTip("Find out more about fugaiWeb")  # Hungry!
    ...
    def navigate_home(self):
        self.tabs.currentWidget().setUrl(QUrl("https://github.com/nettomo5"))
...
webApp.setApplicationName("Mozarella Ashbadger")
webApp.setOrganizationName("Nettomo")
webApp.setOrganizationDomain("https://github.com/nettomo")
